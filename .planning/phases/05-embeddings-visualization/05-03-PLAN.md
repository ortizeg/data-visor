...
<task type="auto">
  ...
  <verify>
    - `cd /Users/ortizeg/1Projects/⛹️‍♂️\ Next\ Play/code/data-visor/frontend && npx tsc --noEmit` -- TypeScript compilation passes: confirms types, hooks (useEmbeddingCoordinates, useEmbeddingStatus, useGenerateEmbeddings, useReduceEmbeddings, useEmbeddingProgress) are importable and type-safe with correct return types
